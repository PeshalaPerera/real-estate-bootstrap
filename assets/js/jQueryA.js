...
$(function() {
	$( "#Search" ).on("click", function() {
		...
		let property_single_placeholder = "";
			...
			console.log(properties);
				...
				if (( searchType == data.properties[i].type) || (searchType=="Any")) {
					if (( propType == data.properties[i].type) || (propType=="Any")) {
						...
						property_single_placeholder += `<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-md-6">
				...
				document.getElementById( "property_single_placeholder" ).innerHTML = property_single_placeholder;
		   });
	});
